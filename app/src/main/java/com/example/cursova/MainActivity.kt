...
@Composable
fun ModuleCard(iconResId: Int, title: String, description: String, sections: Int, iconColor: Brush, textColor: Color, textBacColor:Color) {
    Card(
        modifier = Modifier
        ...
        Box(
            ...
            Row(
                ...
                Column {
                    ...
                    Box(
                        modifier = Modifier
                            .background(textBacColor,shape = RoundedCornerShape(15.dp)) // Фон для текста с количеством разделов
                            .padding(5.dp)
                    ) {
                        Text(
