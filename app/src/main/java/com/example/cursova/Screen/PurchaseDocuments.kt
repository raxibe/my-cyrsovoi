    ...
    Scaffold(
        ...
        Box(
            ...
            LazyColumn(
                ...
                items(purchaseDocuments) { purchaseDocument ->
                    PurchaseDocumentCard(
                        purchaseDocument = purchaseDocument,
                        onDeleteClick = { viewModel.deletePurchaseDocument(purchaseDocument) }
                    )
                }
            }
        }
        ...
        Box(
            ...
            Row(
                ...
                Column(
                    ...
                    modifier = Modifier
                        .weight(1f) // Добавляем вес, чтобы колонка не выходила за пределы карточки
                ) {
                    Text(
                    ...
                    Text(
                        ...
                        style = MaterialTheme.typography.bodyMedium,
                        softWrap = true, // Добавляем softWrap = true, чтобы текст переносился на новую строку
                        overflow = TextOverflow.Visible // Добавляем overflow = TextOverflow.Visible, чтобы текст не обрезался
                    )
                }
                IconButton(
